...
/* harmony import */ var _modules_changeUserState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/changeUserState */ "./src/js/modules/changeUserState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var userState = {};
  Object(_modules_changeUserState__WEBPACK_IMPORTED_MODULE_4__["default"])(userState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(userState);
  ...
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["default"])(userState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2021-12-31');
  Object(_modules_images__WEBPACK_IMPORTED_MODULE_6__["default"])();
});

/***/ }),

/***/ "./src/js/modules/changeUserState.js":
/*!*******************************************!*\
  !*** ./src/js/modules/changeUserState.js ***!
  \*******************************************/
...
/* harmony import */ var _validationModule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validationModule */ "./src/js/modules/validationModule.js");



var changeUserState = function changeUserState(state) {
  ...
  Object(_validationModule__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_validationModule__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
        ...
        switch (item.tagName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              elem.forEach(function (season, j) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeUserState);
...
/* harmony import */ var _validationModule__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./validationModule */ "./src/js/modules/validationModule.js");
...
var form = function form(state) {
  ...
  Object(_validationModule__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="user_phone"]');
  var message = {
    loading: 'Загрузка...',
  ...
  function postData(form) {
    form.addEventListener('submit', function (e) {
      ...
      processingPostData('assets/server.php', formData).then(function (data) {
        console.log(data);
...
var images = function images() {
  var imagesParent = document.querySelector('.works'),
...
var tabs = function tabs(tabSelector, tabsParentSelector, tabsContentSelectoor, activeSelector) {
  var displayStatus = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  ...
  function hideTabContent() {
    ...
    tabs.forEach(function (item) {
      return item.classList.remove(activeSelector);
    });
  }

  function showTabContent() {
    var i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    tabsContent[i].style.display = displayStatus;
...
var timer = function timer(id, deadLine) {
  ...
  function setTimeRemaning(selector, lastDay) {
    ...
    function changeClock() {
      var timer = getTimeRemaning(lastDay);
...
/***/ "./src/js/modules/validationModule.js":
/*!********************************************!*\
  !*** ./src/js/modules/validationModule.js ***!
  \********************************************/
/*! exports provided: default */
...
var validationModule = function validationModule(selector) {
  var itemValidation = document.querySelectorAll(selector);
  itemValidation.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (validationModule);
